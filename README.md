...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ym6plb0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ym6plb0.containers.anotherwebservice.com/
...
```
git clone git@github.com:Eapalmoms/container-ym6plb0.git
cd container-ym6plb0
```
...
```
docker attach container-ym6plb0
```
